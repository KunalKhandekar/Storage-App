...
export default function FileViewer() {
  ...
  // If not file in state -> Fetch file info by fileId. (Left)
              ...
              <div className="flex items-center space-x-3 sm:space-x-4">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-3 mb-1">
                    ...
                    <h1 className="text-lg sm:text-xl lg:text-2xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent truncate" title={file.name}>
                      {file.name}
                    </h1>
                  </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm border border-gray-200/60 rounded-xl sm:rounded-2xl shadow-sm overflow-hidden">
            <div className="p-4 sm:p-6 border-b border-gray-100">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-sm lg:text-base font-medium text-gray-900">File Preview</h3>
              </div>
            </div>
